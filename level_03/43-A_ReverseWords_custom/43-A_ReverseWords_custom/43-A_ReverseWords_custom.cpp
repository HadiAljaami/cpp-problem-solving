// 43-A_ReverseWords_custom.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
 /*// wirte a program toreplace words in string using custom funtion:
*/
